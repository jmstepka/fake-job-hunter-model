...
file = open("/Users/gabrielalibudzka/Desktop/fake-job-hunter-model/new-offers-generator/jobs.txt")
...
#   prompt=f"Ponizej znajduja sie przyklady podejrzanych ogloszen o prace. Napisz opis podobnego ogloszenia {file}",
#   temperature=0.25,
#   max_tokens=2000,
#   top_p=1,
#   frequency_penalty=0,
...
file_path = 'jobs_output4_completion.txt'
